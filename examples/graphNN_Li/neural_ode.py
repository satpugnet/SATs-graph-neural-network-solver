...
parser.add_argument('--method', type=str, choices=['dopri5', 'adams', 'euler'], default='euler')
...
def visualize(true_y, pred_y, odefunc, itr):
    ...
    if args.viz:
        ...
        fig.tight_layout()
        plt.savefig(path + 'png/{:03d}'.format(itr))
        plt.draw()
        #plt.pause(0.001)
